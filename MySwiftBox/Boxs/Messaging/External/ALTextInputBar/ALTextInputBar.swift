...
open class ALTextInputBar: UIView, ALTextViewDelegate {
    ...
    public var shouldShowRightButton : ((_ text : String)->(Bool))?
    ...
    */
    ...
    public let textView: ALTextView = {
        ...
        _textView.textContainerInset = UIEdgeInsets(top: 11, left: 20, bottom: 8, right: 20)
    ...
    public var showRightButton = false {
        didSet {
    ...
    override open func layoutSubviews() {
        ...
        if let view = rightView {
            ...
            if shouldShowRightButton?(self.textView.text) ?? true {
        ...
        if shouldShowRightButton?(self.textView.text) ?? true && rightViewSize.width > 0 {
        ...
        textViewBorderView.frame = textView.frame.inset(by: offset)// UIEdgeInsetsInsetRect(textView.frame, offset)
    }
...
//        let shouldShowButton = !textView.text.isEmpty
        ...
        showRightButton = shouldShowRightButton?(textView.text) ?? true
